...
class ModadminModule extends CWebModule
{
	/**
	...
	*/
	public $flashSuccessKey = 'ModadminSuccess';
	/**
	* @property string the flash message key to use for error messages.
	*/
	public $flashErrorKey = 'ModadminError';
	/**
	...
	*/
	public function getAssetsUrl()
	{
		...
		{
			$assetsPath = Yii::getPathOfAlias('modadmin.assets');
