  ...
  <div class="span12">
	...
	<?php $form=$this->beginWidget('CActiveForm', array(
		...
		<div class="row">
			...
			<?php echo $form->dropDownList($model,'employee_id',CHtml::listData(Employee::model()->findAll(array('order'=>'name')),'employee_id','name'), array('empty'=>'pilih user')); ?>
		...
		<div class="row">
			...
			<?php echo $form->textArea($model,'position_task',array('rows'=>6, 'cols'=>50, 'class'=>'span10')); ?>
		...
		<div class="row">
			...
			<?php echo $form->textArea($model,'remarks',array('rows'=>6, 'cols'=>50, 'class'=>'span10')); ?>
