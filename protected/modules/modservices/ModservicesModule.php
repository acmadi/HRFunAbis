...
class ModservicesModule extends CWebModule
{
	/**
	...
	*/
	public $flashSuccessKey = 'ModservicesSuccess';
	/**
	* @property string the flash message key to use for error messages.
	*/
	public $flashErrorKey = 'ModservicesError';
	/**
	...
	*/
	public $baseUrl = '/modservices';
	/**
	* @property string the path to the layout file to use for displaying modservices.
	*/
	public $layout = 'modservices.views.layouts.main';
	/**
	* @property string the path to the application layout file.
	*/
	public $appLayout = 'application.views.layouts.main';
	/**
	* @property string the style sheet file to use for modservices.
	*/
	public $cssFile;
	/**
	...
	* @return string the base URL that contains all published asset files of modservices.
	*/
	public function getAssetsUrl()
	{
		if( $this->_assetsUrl===null )
		{
			$assetsPath = Yii::getPathOfAlias('modservices.assets');
