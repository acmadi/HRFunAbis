...
/**
 * This is the model class for table "srv_amr_service_type".
 *
 * The followings are the available columns in table 'srv_amr_service_type':
 * @property integer $id
