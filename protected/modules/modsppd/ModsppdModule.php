...
class ModsppdModule extends CWebModule
{
	/**
	...
	*/
	public $flashSuccessKey = 'ModsppdSuccess';
	/**
	* @property string the flash message key to use for error messages.
	*/
	public $flashErrorKey = 'ModsppdError';
	/**
	* @property boolean whether to install modsppd when accessed.
	*/
	public $install = false;
	/**
	* @property string the base url to modsppd. Override when module is nested.
	*/
	public $baseUrl = '/modsppd';
	/**
	* @property string the path to the layout file to use for displaying modsppd.
	*/
	public $layout = 'modsppd.views.layouts.main';
	/**
	* @property string the path to the application layout file.
	*/
	public $appLayout = 'application.views.layouts.main';
	/**
	* @property string the style sheet file to use for modsppd.
	*/
	public $cssFile;
	/**
	...
	* @return string the base URL that contains all published asset files of modsppd.
	*/
	public function getAssetsUrl()
	{
		if( $this->_assetsUrl===null )
		{
			$assetsPath = Yii::getPathOfAlias('modsppd.assets');
