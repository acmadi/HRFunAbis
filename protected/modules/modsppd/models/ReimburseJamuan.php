...
/**
 * This is the model class for table "sppd_reimburse_jamuan".
 *
 * The followings are the available columns in table 'sppd_reimburse_jamuan':
 * @property integer $id
 ...
 */
class ReimburseJamuan extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ReimburseJamuan the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('cc, usage_type, created_by', 'length', 'max'=>50),
