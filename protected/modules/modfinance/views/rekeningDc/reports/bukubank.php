...
if(isset($buku))
{
    ...
    'headerButtons' => array(
		array(
			...
			'buttons'=>array(
				array('label'=>'Export', 'url'=>array('/modfinance/rekeningDc/bukubankpdf'), 'htmlOptions'=>array('target'=>'_blank')),
			),
		),
    ),
	'content'=> $this->renderPartial('reports/_bukubank', array('data' => $buku), true),
	));
}	
?>
