...
class ModfinanceModule extends CWebModule
{
	/**
	...
	*/
	public $flashSuccessKey = 'ModfinanceSuccess';
	/**
	* @property string the flash message key to use for error messages.
	*/
	public $flashErrorKey = 'ModfinanceError';
	/**
	...
	*/
	public $baseUrl = '/modfinance';
	/**
	* @property string the path to the layout file to use for displaying modfinance.
	*/
	public $layout = 'modfinance.views.layouts.main';
	/**
	* @property string the path to the application layout file.
	*/
	public $appLayout = 'application.views.layouts.main';
	/**
	* @property string the style sheet file to use for modfinance.
	*/
	public $cssFile;
	/**
	...
	* @return string the base URL that contains all published asset files of modfinance.
	*/
	public function getAssetsUrl()
	{
		if( $this->_assetsUrl===null )
		{
			$assetsPath = Yii::getPathOfAlias('modfinance.assets');
