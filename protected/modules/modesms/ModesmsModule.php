...
class ModesmsModule extends CWebModule
{
	/**
	...
	*/
	public $flashSuccessKey = 'ModesmsSuccess';
	/**
	* @property string the flash message key to use for error messages.
	*/
	public $flashErrorKey = 'ModesmsError';
	/**
	...
	*/
	public $baseUrl = '/modesms';
	/**
	* @property string the path to the layout file to use for displaying modesms.
	*/
	public $layout = 'modesms.views.layouts.main';
	/**
	* @property string the path to the application layout file.
	*/
	public $appLayout = 'application.views.layouts.main';
	/**
	* @property string the style sheet file to use for modesms.
	*/
	public $cssFile;
	/**
	...
	* @return string the base URL that contains all published asset files of modesms.
	*/
	public function getAssetsUrl()
	{
		if( $this->_assetsUrl===null )
		{
			$assetsPath = Yii::getPathOfAlias('modesms.assets');
