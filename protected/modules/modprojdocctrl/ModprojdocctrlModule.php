...
class ModprojdocctrlModule extends CWebModule
{
	/**
	...
	*/
	public $flashSuccessKey = 'ModprojdocctrlSuccess';
	/**
	* @property string the flash message key to use for error messages.
	*/
	public $flashErrorKey = 'ModprojdocctrlError';
	/**
	...
	*/
	public $baseUrl = '/modprojdocctrl';
	/**
	* @property string the path to the layout file to use for displaying modadmin.
	*/
	public $layout = 'modprojdocctrl.views.layouts.main';
	/**
	...
	*/
	...
	public function init()
	{
		...
		$this->setImport(array(
			'modprojdocctrl.models.*',
			'modprojdocctrl.components.*',
		));
	}
	...
	*/
	public function getAssetsUrl()
	{
		...
		{
			$assetsPath = Yii::getPathOfAlias('modprojdocctrl.assets');
